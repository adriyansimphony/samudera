                            ...
                            <tbody>
                                @foreach ($users as $d)
                                    <tr>
                                        ...
                                        <td>{{ $d->password }}</td>
                                        <td>
                                            <a href="#" class="edit btn btn-info btn-sm mb-2" name="{{ $d->name }}" style="width: 5rem">
                                            ...
                                            <form action="/admin/{{ $d->name }}/delete" method="POST">
                                                @csrf
                                                {{-- @method('DELETE') --}}
                                                <a class="btn btn-danger btn-sm delete-confirm" style="width: 5rem">
